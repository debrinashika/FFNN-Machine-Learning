...
# Inisialisasi 
ffnn = FFNN(batch_size=2, learning_rate=0.01, epoch=5, verbose=1, loss_func='mse', weight_init='uniform')

hidden_layer1 = Layers(n_inputs=3, n_neurons=3, activ_func=tanh)
hidden_layer2 = Layers(n_inputs=3, n_neurons=2, activ_func=tanh)
